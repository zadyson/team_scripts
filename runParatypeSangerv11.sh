#!/bin/bash
#
# Run Paratype May 2023 update on multiple files.
#
# Zoe Dyson zoe.dyson(at)lshtm.ac.uk
# Updated for Sanger cluster 04/10/23, updated for new paratype 08/10/23
...
while read file;
 ...
 do bsub -E 'test -e /nfs/users/nfs_z/zd2' -R "select[mem>16000] rusage[mem=16000]" -M16000 -o ${file}.o -e ${file}.e -J $file -n8 python3 /data/pam/typhinet/scratch/zd2/2023_TyphiNET_ParatyphiA/software_sanger/Paratype_v1.1/paratype.py --id $file --mode fastq --fastq ../reads/${file}/${file}_1.fastq.gz ../reads/${file}/${file}_2.fastq.gz --threads 8 --output ${file}_paratype.txt
