...
while read file;
 ...
 do bsub.py 1 $file ariba run /lustre/scratch125/pam/projects/typhinet/zd2/2023_TyphiNET_ParatyphiA/databases/ariba/card/out.card.prepareref ../reads/$file/${file}_1.fastq.gz ../reads/$file/${file}_2.fastq.gz ${file} --threads 1
